...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO perizinan (id_perizinan,Nama_Satpam,Pengajuan_Cuti, Alasan) 
        VALUES ('$id_perizinan','$nama','$pengajuan','$alasan')";

    if ($conn->query($sql) === TRUE) {
        $popupMessage = "Data Pengajuan berhasil disimpan!";
        $popupType = "success";
    } else {
...
<body class="bg-gray-900 font-sans text-gray-200">
    ...
    <div class="container mx-auto p-6 max-w-4xl">
        ...
        <!-- Form -->
        <form id="absensiForm" action="izin.php" method="POST" class="space-y-6 bg-gray-800 p-6 rounded-lg shadow-lg">
            <div class="space-y-4">
               <div>
                    <label for="nama" class="block text-sm font-medium text-blue-500">Id perizinan</label>
                    <input
                        type="text"
                        name="id_perizinan"
                        id="id_perizinan"
